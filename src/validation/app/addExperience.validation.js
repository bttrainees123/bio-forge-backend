        ...
        return Joi.object({
            ...
            education: Joi.object({
                ...
                AddUnderGraduate: Joi.string()
                    ...
                    .messages({
                        "any.only": "Invalid undergraduate selection"
                    }),
                AddPostGraduate: Joi.string()
                    .valid(
                    ...
                    .messages({
                        "any.only": "Invalid postgraduate selection"
                    }),
                AddDoctoral: Joi.string()
                    .valid(
                        'IIT Bombay',
                        'IIT Delhi',
                        'AIIMS Delhi',
                    ...
                    .messages({
                        "any.only": "Invalid doctoral selection"
                    })
            }).messages({
    ...
    static updateExperience() {
        return Joi.object({
            ...
            education: Joi.object({
                ...
                AddUnderGraduate: Joi.string().valid(
                    'University of Delhi',
                    'Banaras Hindu University',
                    'Jadavpur University',
                    'Christ University',
                ...
                AddPostGraduate: Joi.string().valid(
                    'Jawaharlal Nehru University',
                    'Indian Institute of Science',
                    'Tata Institute of Social Sciences',
                    'Jamia Millia Islamia',
